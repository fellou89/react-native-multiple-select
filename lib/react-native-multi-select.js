...
export default class MultiSelect extends Component {
  static propTypes = {
    ...
    selectedWrapperStyle: PropTypes.object,
  ...
  _displaySelectedItems = () => {
    ...
    return selectedItems.map(item => (
      ...
      >
        <Text style={[styles.selectedItemText, this.props.selectedItemTextStyle,
          {
            ...
            <View>
              ...
              </View>
              {
                this.state.selectedItems.length ?
                  <ScrollView
                    horizontal={false}
                    style={[styles.selectedWrapper,this.props.selectedWrapperStyle]}
                    contentContainerStyle={[styles.slectedContainerWrapper]}
                  >
